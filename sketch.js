...
function setup() 
{
  ...
  button.mouseClicked(drop);
   ...
   blower.position(190, height/2-80)
   blower.size(120,120)
  ...
  star1 = createSprite(250, 40, 20, 20)
  star1.addImage(starimg)
  star1.scale = 0.02

  star2 = createSprite(30, height/2-40, 20, 20)
  star2.addImage(starimg)
  star2.scale = 0.02

  star_display = createSprite(100,50,30,30)
  star_display.scale = 0.2
  star_display.addAnimation("no_stars",nostar)
  star_display.addAnimation("one_star", onestar)
  star_display.addAnimation("two_stars",twostar)
  star_display.changeAnimation("no_stars")
